...
var score,heart,heart1,heart2,heart3,heartimg,food,food1,food2,food3,foodgroup,obstacle,obstaclegroup,obs1,obs2,zombiestop,respawnimg,youdied,scor,scoro,respawn,youdiedimg, scorimg,heartscore,foodsound,obssound,bgmusic;


function preload()
{
  foodsound=loadSound("sad.mp3")
  obssound=loadSound("notsad.mp3")
  bgmusic=loadSound("bgmusic.mp3")
  bgimg=loadImage("Untitled.png");
  food1=loadImage("bread1.png");
  food2=loadImage("carrot1.png");
